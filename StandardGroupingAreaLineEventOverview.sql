...
SELECT m.[EventDefinitionName] [GroupValue], m.[EventDefinitionName] [GroupLabel], m.[EventDefinitionDisplayOrder] [GroupDisplayOrder], 1 [SeriesValue] 
, 1 [SeriesLabel] 
...
GROUP BY
 m.[EventDefinitionName], ed.Color, m.[EventDefinitionDisplayOrder], m.[SiteID]
